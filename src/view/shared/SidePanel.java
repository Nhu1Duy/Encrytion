...
public class SidePanel extends JPanel {
    ...
    private void buildFileSection() {
        ...
        fileSection.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), "Mã hóa / Giải mã File"));
        fileSection.setVisible(false); // ẩn khi ở Classic mode

        GridBagConstraints lc = new GridBagConstraints();
        lc.gridx = 0; lc.anchor = GridBagConstraints.WEST;
        lc.insets = new Insets(3, 4, 3, 4); lc.fill = GridBagConstraints.NONE;

        GridBagConstraints fc = new GridBagConstraints();
        fc.gridx = 1; fc.fill = GridBagConstraints.HORIZONTAL;
        fc.weightx = 1.0; fc.insets = new Insets(3, 0, 3, 2);

        GridBagConstraints bc = new GridBagConstraints();
        bc.gridx = 2; bc.insets = new Insets(3, 2, 3, 4);
        ...
        row2.gridy = 2; row2.gridx = 0; row2.gridwidth = 3;
    ...
    public void addCard(JPanel panel, String key) { cardPanel.add(panel, key); }

    public void showCard(String key) {
        cardLayout.show(cardPanel, key);
        TitledBorder tb = (TitledBorder) cardPanel.getBorder();
        if (tb != null) { tb.setTitle("Thuật toán: " + key); cardPanel.repaint(); }
    }
    ...
    public JButton getBrowseInputBtn() { return browseInputBtn; }
    public JButton getBrowseOutputBtn(){ return browseOutputBtn; }
    public JButton getEncryptFileBtn() { return encryptFileBtn; }
    public JButton getDecryptFileBtn() { return decryptFileBtn; }
    public JTextField getInputPathField()  { return inputPathField; }
    public JTextField getOutputPathField() { return outputPathField; }
}