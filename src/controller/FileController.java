...
/**
 * FileController – xử lý các thao tác file:
 * import/save input, output, key; xóa toàn bộ.
 */
public class FileController {
    ...
    private void bindImportInput() {
        ctx.view.getItemImportInput().addActionListener(e -> {
            ...
            if (content != null) ctx.view.getInputArea().setText(content);
        });
    }
    ...
    private void importKeyToCurrentPanel(String raw) {
        try {
            ...
            JOptionPane.showMessageDialog(ctx.view.frame,
                    "Đã nạp khóa vào " + ctx.currentMethod + " thành công.",
